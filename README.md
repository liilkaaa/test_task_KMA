...
Перевірка розподілу інтервалів між успішними ребілами показала p25=21, медіана=29, p75=37 днів, це дало б обґрунтування для порогу (напр. 14 днів). Але подальше дослідження конкретних кейсів (`u_010dd86cd5b3`) показало межові випадки: перехід із trial-ціни на повну ($15.28 → $61.18) стається з гапом усього 16 днів. Тому ми не можемо пропускати, що проміжок може бути і меншим.
