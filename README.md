...
Я використовувала ШІ інструменти для знаходження певних користувачів, у яких поведінка відрізняється від інших, щоб трохи зекономити час і не все шукати через SQL запити. Також використовувала для відшліфування фінального SQL запиту, якщо у мене виникали дивні результати або помилки. Також я знаходила метрики у статтях і потім в ШІ запитувала, які найкраще підійдуть до мого датасету. У EDA найбільше використовувала для візуалізацій, щоб це не займало багато часу. Ну і також допомагав мені писати деякі фрагменти коду. Також використала ШІ на фіналі, коли скинула всі свої рішення і висновки, і AI структурував мені це все для написання звіту у гітхабі
